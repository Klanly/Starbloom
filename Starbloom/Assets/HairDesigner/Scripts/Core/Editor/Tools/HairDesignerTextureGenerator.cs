    ...
    namespace HairDesignerExtension
    {
        ...
        public class HairDesignerTextureGeneratorWindow : EditorWindow
        {
            ...
            void OnGUI()
            {
                ...
                */
                ...
                else
                {
                    ...
                    {
                        if (m_specularMode != eSpecularMode.COMBINED)
                        {
                ...
                switch (tabParametersID)
                {
                    case 0:
                        ...
                        m_parameters.m_rnd = EditorGUILayout.FloatField("Random", m_parameters.m_rnd);
                ...
                {
                    int choice = EditorUtility.DisplayDialogComplex("Copy texture parameters", "all the other texture parameters will be overwrite", "Ok", "Cancel", "Copy with random");
            ...
            public void BakeTexture(int size)
            {
                ...
                Material mat = new Material(Shader.Find("Hidden/HairDesigner_TextureGenerator"));
                ...
                if (m_atlasParameters.m_enableNormal)
                {
                    m_pb.SetFloat("_textureID", (float)eTextureID.NORMAL);
                    mr.SetPropertyBlock(m_pb);
                    renderCam.Render();
                ...
                if (m_atlasParameters.m_enableAO)
                {
                    m_pb.SetFloat("_textureID", (float)eTextureID.AO);
                    mr.SetPropertyBlock(m_pb);
                    renderCam.Render();
                ...
                if (m_atlasParameters.m_enableSpecular)
                {
                    m_pb.SetFloat("_textureID", (float)eTextureID.SPECULAR_ANISO);
                    m_pb.SetFloat("_specularMode", (float)m_specularMode);
                    mr.SetPropertyBlock(m_pb);
                    renderCam.Render();
