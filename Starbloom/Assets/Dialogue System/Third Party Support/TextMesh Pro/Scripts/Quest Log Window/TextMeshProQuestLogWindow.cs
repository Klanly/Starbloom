...
namespace PixelCrushers.DialogueSystem.TextMeshPro
{
    ...
    /// <summary>
    /// This is an implementation of the abstract QuestLogWindow class for 
    /// Unity UI and TextMeshPro.
    /// </summary>
    [AddComponentMenu("Dialogue System/Third Party/TextMesh Pro/Quest/TextMesh Pro Quest Log Window")]
    public class TextMeshProQuestLogWindow : QuestLogWindow
    {
        ...
        /// The quest template.
        /// </summary>
        [Tooltip("Template to use when populating the quest log window.")]
        ...
        /// </summary>
        [Tooltip("Confirmation panel to show if the player clicks the abandon quest button.")]
        public UnityEngine.UI.Graphic abandonPopup;

        /// <summary>
        /// The quest title label to set in the abandon quest dialog popup.
        /// </summary>
        [Tooltip("Contains the name of the quest to confirm abandoning.")]
        public TMPro.TextMeshProUGUI abandonQuestTitle;
        ...
        private void AddQuestToTable(QuestInfo questInfo, int questIndex)
        {
            ...
            TextMeshProQuestTemplate questControl = questGameObject.GetComponent<TextMeshProQuestTemplate>();

            // Set the heading button:
            var questHeadingButton = questControl.heading;
            questHeadingButton.GetComponentInChildren<TMPro.TextMeshProUGUI>().text = questInfo.Heading.text;
