...
namespace PixelCrushers.DialogueSystem.TextMeshPro
{
    ...
    public class TextMeshProDialogueUI : AbstractDialogueUI
    {
        ...
        /// <summary>
        /// Set <c>true</c> to look for OverrideTextMeshProDialogueControls on actors.
        /// </summary>
		[Tooltip("Look for OverrideTextMeshProDialogueControls on actors.")]
        ...
        public override void ShowSubtitle(Subtitle subtitle)
        {
            ...
            base.ShowSubtitle(subtitle); // Calls TextMeshProSubtitleControls.ShowSubtitle().
            ClearSelection();
