...
namespace PixelCrushers.DialogueSystem.TextMeshPro
{
    ...
    public class TextMeshProResponseMenuControls : AbstractUIResponseMenuControls
    {
        ...
        private void SetupTemplateButtonNavigation()
        {
            ...
            {
                var button = instantiatedButtons[i].GetComponent<TextMeshProResponseButton>().button;
                var above = (i == 0) ? null : instantiatedButtons[i - 1].GetComponent<TextMeshProResponseButton>().button;
                var below = (i == instantiatedButtons.Count - 1) ? null : instantiatedButtons[i + 1].GetComponent<TextMeshProResponseButton>().button;
        ...
        public void DefaultTimeoutHandler()
        {
            ...
            {
                var currentButton = UnityEngine.EventSystems.EventSystem.current.currentSelectedGameObject.GetComponent<TextMeshProResponseButton>();
        ...
        private IEnumerator DisableAfterAnimation(UnityEngine.UI.Graphic panel)
        {
            ...
            if (animator != null)
            {
                var maxWaitDuration = UIShowHideController.maxWaitDuration;
