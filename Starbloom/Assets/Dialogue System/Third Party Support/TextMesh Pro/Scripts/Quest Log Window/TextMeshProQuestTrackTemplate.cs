...
namespace PixelCrushers.DialogueSystem.TextMeshPro
{
    ...
    public class TextMeshProQuestTrackTemplate : MonoBehaviour
    {
        ...
        {
            // Added: If no entry container is assigned, used myself as the container.
            if (entryContainer == null) entryContainer = this.transform;

            if (entryContainer == null) // This section is no longer used.
            {
