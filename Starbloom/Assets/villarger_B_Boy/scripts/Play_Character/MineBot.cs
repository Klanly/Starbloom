...
public class MineBot: MonoBehaviour {
	...
	static int jumpState = Animator.StringToHash("Base Layer.VB_F_Jump");
	static int jump01State = Animator.StringToHash("Base Layer.VB_F_Jump01");
	static int attack01State = Animator.StringToHash("Base Layer.VB_Attack01");
	static int RunState = Animator.StringToHash("Base Layer.VB_F_Run");
	static int Run01State = Animator.StringToHash("Base Layer.VB_F_Run01");
	static int StandState = Animator.StringToHash("Base Layer.VB_Attackstandy");
	static int IdleState = Animator.StringToHash("Base Layer.VB_Idle");
...
//				Land ();
//			}
//			if (currentBaseState.nameHash == Run01State)
//			{
//				Land ();
//			}
//
...
//			}
			...
			if (currentBaseState.nameHash == jump01State)
			{
				if(Input.GetButtonDown("Fire1"))
				{
					avatar.SetBool("Rappel", true);
