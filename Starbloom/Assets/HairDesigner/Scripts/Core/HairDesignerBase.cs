...
namespace Kalagaan
{
    namespace HairDesignerExtension
    {
        ...
        {            
            public static string version = "1.5.7";//package version
            public string m_version = "1.5.7";//instance version
            ...
            public List<CapsuleCollider> m_capsuleColliders;
            ...
            void LateUpdate()
            {
                ...
                if (Application.isEditor && !Application.isPlaying)
                {
                    ...
                    for (int i = 0; i < generators.Length; ++i)
                        generators[i].hideFlags = HideFlags.DontSave;

                    HairDesignerShader[] shaders = GetComponents<HairDesignerShader>();
                    for (int i = 0; i < shaders.Length; ++i)
                        shaders[i].hideFlags = HideFlags.DontSave;
