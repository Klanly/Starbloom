...
public class SyncBuffer : MonoBehaviour
{
    ...
    /// </summary>
    [Range(0.1f, 5f)]
    public float TimeCorrectionSpeed = 2f;
    ...
    /// </summary>
    public Vector3 PositionNoErrorCorrection
    {
        get
        {
            if (!HasKeyframes)
    ...
    /// </summary>
    public Quaternion RotationNoErrorCorrection
    {
        get
        {
            if (!HasKeyframes)
    ...
    /// </summary>
    public Keyframe LastReceivedKeyframe
    {
        get
        {
            if (!HasKeyframes)
    ...
    public void AddKeyframe(float interpolationTime, Vector3 position, Quaternion rotation = default(Quaternion), Vector3? velocity = null, Vector3? angularVelocity = null, Vector3 acceleration = default(Vector3), Vector3 angularAcceleration = default(Vector3))
    {
